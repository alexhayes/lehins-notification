...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticeType.level'
        db.add_column(u'notification_noticetype', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.NoticeLevel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoticeType.level'
        db.delete_column(u'notification_noticetype', 'level_id')
