...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoticeLevel'
        db.create_table(u'notification_noticelevel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=32)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'notification', ['NoticeLevel'])


    def backwards(self, orm):
        # Deleting model 'NoticeLevel'
        db.delete_table(u'notification_noticelevel')
