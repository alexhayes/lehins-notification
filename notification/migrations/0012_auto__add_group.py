...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table(u'notification_group', (
        ...
        db.send_create_signal(u'notification', ['Group'])

        # Adding M2M table for field notice_types on 'Group'
        db.create_table(u'notification_group_notice_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm[u'notification.group'], null=False)),
            ('noticetype', models.ForeignKey(orm[u'notification.noticetype'], null=False))
        ))
        db.create_unique(u'notification_group_notice_types', ['group_id', 'noticetype_id'])


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table(u'notification_group')

        # Removing M2M table for field notice_types on 'Group'
        db.delete_table('notification_group_notice_types')
    ...
    models = {
        ...
        u'notification.group': {
            'Meta': {'object_name': 'Group', '_ormbases': [u'auth.Group']},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'group_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.Group']", 'unique': 'True', 'primary_key': 'True'}),
            'notice_types': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['notification.NoticeType']", 'symmetrical': 'False'}),
        ...
        u'notification.notice': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_notices'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'notification.noticetype': {
            ...
            'level': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notification.NoticeLevel']", 'null': 'True', 'blank': 'True'}),
